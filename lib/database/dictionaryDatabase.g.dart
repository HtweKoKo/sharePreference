...
part of 'dictionaryDatabase.dart';
...
class DictionaryTableData extends DataClass
  ...
  DictionaryTableData copyWith(
      ...
      DictionaryTableData(
        ...
        myan: myan ?? this.myan,
        type: type ?? this.type,
        favourite: favourite.present ? favourite.value : this.favourite,
      );
  @override
  String toString() {
...
class $DictionaryTableTable extends DictionaryTable
  ...
  DictionaryTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return DictionaryTableData(
      ...
      eng: attachedDatabase.options.types
          .read(DriftSqlType.string, data['${effectivePrefix}eng'])!,
      myan: attachedDatabase.options.types
          .read(DriftSqlType.string, data['${effectivePrefix}myan'])!,
      type: attachedDatabase.options.types
          .read(DriftSqlType.string, data['${effectivePrefix}type'])!,
      favourite: attachedDatabase.options.types
